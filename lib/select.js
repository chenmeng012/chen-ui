...
module.exports = require("chen-ui/lib/mixins/focus");
          ...
          _c(
            ...
            [
              ...
              (!_vm.allowCreate ||
                ...
                : _vm._e(),
              _vm.bottomButtonOption && _vm.bottomButtonOption.visible
                ? _c(
                    "div",
                    {
                      staticClass: "el-select-dropdown__bottom-button",
                      on: { click: _vm.handleBottomButtonClicked }
                    },
                    [_vm._v(_vm._s(_vm.bottomButtonOption.title))]
                  )
                : _vm._e()
            ],
            2
...
// EXTERNAL MODULE: external "chen-ui/lib/mixins/focus"
...
/* harmony default export */ var selectvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    bottomButtonOption: function bottomButtonOption() {
      var defaultOption = {
        visible: false, // 是否显示
        title: null, // 显示文本
  ...
  methods: {
    ...
    handleBottomButtonClicked: function handleBottomButtonClicked() {
      var _this13 = this;
